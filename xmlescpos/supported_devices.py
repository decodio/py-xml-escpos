...
device_list = [
    ...
    { 'vendor' : 0x1504, 'product' : 0x0006, 'name' : 'BIXOLON SRP-350plus', 'in_ep': 0x01, 'out_ep': 0x01 },
    { 'vendor' : 0x0525, 'product' : 0xa700, 'name' : 'Netchip Tech., Inc. MicroPOS WTP-100ESC', 'in_ep': 0x82, 'out_ep': 0x01  },
]
